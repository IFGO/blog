        ...
        <div id="masthead">  
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Blog
                            <p class="lead">Rock de Igreja</p>
                        </h1>
                        <img src="http://www.saladarock.com.br/blog/wp-content/uploads/2012/07/igreja_pantokrator_colombia.jpg" class="img-responsive pull-right"/>
                    </div>
                </div> 
            </div><!-- /cont -->
                                ...
                                <div class="col-md-10 col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-9">
                                            ...
                                            <p class="lead"><button class="btn btn-default">Continue Lendo...</button></p>
