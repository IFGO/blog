        ...
        <div class="container-fluid display-table">
            ...
            <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                  <input id="textinputNome" name="textinputNome" type="text" placeholder="" class="form-control input-md" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                  <input id="textinputEmail" name="textinputEmail" type="text" placeholder="" class="form-control input-md" required="">
                ...
                <!-- Select Basic -->
                <div class="form-group">
                  <label class="col-md-4 control-label" for="selectbasicData">Data de Nascimento</label>
                  <div class="col-md-4">
                    <select id="selectbasicData" name="selectbasicData" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="passwordinput1" name="passwordinput1" type="password" placeholder="" class="form-control input-md" required="">
